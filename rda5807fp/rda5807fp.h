...
#define RDA5807_SEEK \
    (1 << 0) /* Stop seek (0) / start seek in SEEKUP direction (1) */
...
/* 3 register (03L) */
/* CHAN 1.. 0 bits */
#define RDA5807_DIRECT_MODE                          \
    (1 << 5) /* Direct mode (1), only used when test \
              */
...
/* 6 register (05H) */
#define RDA5807_INT_MODE \
    (1 << 7)                /* 5ms interrupt for RDSIEN on RDS ready (0) */
#define RDA5807_SEEKTH 0x0F /* Seek SNR threshold, 4bits, default 1000=32dB */

/* 7 register (05L) */
#define RDA5807_LNA_PORT_SEL \
    (2 << 6) /* Only for RDA5807FP 2 bit (10) to select FMIN input */
#define RDA5807_VOLUME 0x0F /* 4 bits volume (0000 - muted, 1111 - max) */

/* 8 register (06H) */
#define RDA5807_OPEN_MODE \
    0x60 /* 2 bits (11) to open read-only regs for writing */
...
/* 10 register (07H) */
#define RDA5807_TH_SOFRBLEND \
    0x7C /* 5 bits for noise soft blend, default 10000 */
...
#define RDA5807_BLK_E \
    (1 << 3)                /* (When RDS enabled) block E has been found (1)*/
...
void set_volume(uint8_t volume);  // Write volume
